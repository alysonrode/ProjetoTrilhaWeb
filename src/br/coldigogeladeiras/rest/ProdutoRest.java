...
public class ProdutoRest extends UtilRest {
	...
	public Response inserir(String produtoParam) {
		try {
			...
			// Primeiramente criamos um objeto da classe Produto, e recebemos o objeto que
			// veio do banco em jSon e re-convertemos, passando de parametro
			...
			boolean integridade = jdbcMarca.verificaIntegridadeProduto(produto.getMarcaId());

			if (integridade) {
				JDBCProdutoDAO jdbcProduto = new JDBCProdutoDAO(conexao);
				boolean igualdade = jdbcProduto.validaIguais(produto.getModelo());
				...
				if (igualdade) {
					...
					return this.buildErrorResponse("Já existe esse modelo cadastrado");
				}
			} else {
				conec.fecharConexao();
